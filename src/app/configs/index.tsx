const EXTENSION_URL = 'https://chromewebstore.google.com/detail/bringid/fjlmbkpfjmbjokokgmfcijlliceljbeh';
...
const AUTH_DOMAIN = 'https://staging-oauth-server-production.up.railway.app';
